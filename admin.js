...
async function loadPlayers() {
    try {
        ...
        players.forEach(player => {
            ...
            const winRate = player.win_rate !== null ? player.win_rate.toFixed(1) : '0.0';
            const airmailPercentage = player.airmail_percentage !== null ? player.airmail_percentage.toFixed(1) : '0.0';
            const pushPercentage = player.push_percentage !== null ? player.push_percentage.toFixed(1) : '0.0';
            ...
            row.innerHTML = `
                ...
                <td>${winRate}%</td>
                <td>${airmailPercentage}%</td>
                <td>${pushPercentage}%</td>
...
async function handleAddPlayer(e) {
    ...
    try {
        ...
        const airmailPercentageInput = document.getElementById('airmailPercentage');
        const pushPercentageInput = document.getElementById('pushPercentage');
        const potentialPointsInput = document.getElementById('potentialPoints');
        const profilePictureInput = document.getElementById('profilePicture');
        const form = document.getElementById('addPlayerForm');
        const modal = document.getElementById('addPlayerModal');
        
        if (!nameInput || !rankInput || !winRateInput || !airmailPercentageInput || 
            !pushPercentageInput || !potentialPointsInput || !form || !modal) {
        ...
        const newPlayer = {
            ...
            win_rate: parseFloat(winRateInput.value),
            airmail_percentage: parseFloat(airmailPercentageInput.value),
            push_percentage: parseFloat(pushPercentageInput.value),
...
async function openEditPlayerModal(playerId) {
    try {
        ...
        const winRateInput = document.getElementById('editWinRate');
        const airmailPercentageInput = document.getElementById('editAirmailPercentage');
        const pushPercentageInput = document.getElementById('editPushPercentage');
        ...
        if (!idInput || !nameInput || !rankInput || !winRateInput || !airmailPercentageInput || 
            !pushPercentageInput || !potentialPointsInput || !actualPointsInput || !modal) {
            showToast('Error: Form elements missing', 'error');
            return;
        }
        ...
        winRateInput.value = player.win_rate;
        airmailPercentageInput.value = player.airmail_percentage;
        pushPercentageInput.value = player.push_percentage;
...
async function viewTeamDetails(teamId) {
    try {
                            ...
                            <div class="player-stats">
                                <div class="stat-row">
                                    <div class="stat-item">
                                        ...
                                        <div class="stat-value">${player.win_rate !== null ? player.win_rate.toFixed(1) : '0.0'}%</div>
                                    </div>
                                    <div class="stat-item">
                                ...
                                <div class="stat-row">
                                    <div class="stat-item">
                                        <div class="stat-label">Airmail %</div>
                                        <div class="stat-value">${player.airmail_percentage !== null ? player.airmail_percentage.toFixed(1) : '0.0'}%</div>
                                    </div>
                                    <div class="stat-item">
                                ...
                                <div class="stat-row">
                                    <div class="stat-item">
                                        ...
                                        <div class="stat-value">${player.push_percentage !== null ? player.push_percentage.toFixed(1) : '0.0'}%</div>
                                    </div>
                                    <div class="stat-item">
        ...
        // Add styles for the new team details view
...
// Load players assigned to a tournament
